   ...
   <div class="block span12">
        ...
        <div id="widget2container" class="block-body collapse in">
            ...
            <thead>
              ...
              <tbody>
              <?php $qury1=mysql_query("SELECT * FROM circular WHERE ay_id=$acyear AND (b_id=$bid OR b_id='0') AND (type='Student' OR type='All') AND Status='1' ORDER BY cl_id DESC"); 
						$count =1;
                  ...
                  <tr>
                      ...
                      <td><?php if($row3['file']){?><a href="download.php?clid=<?php echo $row3['cl_id'];?>" class="btn btn-warning btn-large">Download</a><?php } ?></td>
                  </tr>
                  <?php } }else { ?>
                  <tr>
                  		<td><?php echo $count; ?></td>
