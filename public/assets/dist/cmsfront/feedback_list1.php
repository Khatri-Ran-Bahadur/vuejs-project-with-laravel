...
<div class="row-fluid" style="min-height:320px">
   <div class="block">
                ...
                <div id="tablewidget" class="block-body collapse in">
                    ...
                    <?php  $select_record2=mysql_query("SELECT * FROM ssfeedback WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND b_id=$bid AND ay_id=$acyear");		
						$totalcount=0;				
            ...
            <table class="table">
              ...
              <?php 
			  	$count1=1;
						 $select_record2=mysql_query("SELECT * FROM ssfeedback WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND ay_id=$acyear ORDER BY ssf_id DESC");						
					while($classtest21=mysql_fetch_array($select_record2))
					{ 
