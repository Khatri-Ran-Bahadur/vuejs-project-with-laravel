...
error_reporting(E_ALL ^ E_NOTICE);
 ...
 //echo $acyear; 
  if (isset($_POST['send'])) {
	  ...
	  $sql=mysql_query("INSERT INTO feedback (st_id,p_id,title,msg,date,c_id,s_id,b_id,ay_id,status,send) VALUES
('$stid','$pid','$title','$msg','$todaydate','$cid','$sid','$bid','$acyear','1','parent')");
	 if($sql){
		 	 header("Location:feedback_reply.php?stid=$stid&msg=succ");		 	 
	 }else{
		 header("Location:feedback_reply.php?stid=$stid&msg=err");
	 }
    ...
    <div class="content">
        <?php include("includes/head.php");?>
         <?php
            ...
            <li><a href="pstaff_feedback.php">Staff wise Feedback</a> <span class="divider">/</span></li>
   ...
   <div class="block span12">
        ...
        <div id="widget2container" class="block-body collapse in">
            ...
            <!--<thead>
              ...
              <tbody>
              <?php $qury1=mysql_query("SELECT * FROM feedback WHERE c_id=$cid AND s_id=$sid AND st_id=$stid AND p_id=$pid AND ay_id=$acyear AND b_id=$bid"); 
						$totasl =0;
                  ...
                  <tr style="border:1px solid #C1C0C0;">
                      <td width="150px;">
                          <?php if($send=="parent"){ echo "<strong> You<br></strong><span style=' font-size:12px'>".$subject3['date']."</span> "; } else { echo "<strong>".$result3['fname']." ".$result3['mname']." ".$result3['lname']."<br></strong><span style=' font-size:12px'>".$subject3['date']."</span> ";}?>                        
                      </td>
