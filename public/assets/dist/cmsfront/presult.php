  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <?php include("includes/head.php");?>
            ...
            <li><a href="pexamlist.php">Exam List</a> <span class="divider">/</span></li>
...
<div class="row-fluid">
    ...
    <div class="block span8">
        <a href="#tablewidget" class="block-heading" data-toggle="collapse"><?php echo $class['c_name']." - ".$section['s_name'];?> Result Details<span class="label label-warning"><?php echo $exam['e_name'];?></span></a>
