...
<div class="row-fluid">
			  ...
			  while($row1=mysql_fetch_array($qry1))
        		{
                 ...
                 <a href="phomework.php?subid=<?php echo $row1['sub_id']; ?>&mid=<?php echo $mid;?>" class="btn btn-success btn-large" style="margin:0px 0 0 10px;"><?php echo $slist1['s_name']; ?></a>
                <?php } ?> 
    ...
    <script type="text/javascript">
     ...
     var mid =document.getElementById('mid').value;
	  window.location.href = 'phomework.php?mid='+mid+'&subid=<?php echo $subid;?>';	
	} 
    </script>
  </body>
</html>
