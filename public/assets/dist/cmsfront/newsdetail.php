...
<div class="row-fluid" style="min-height:320px">
   <div class="block span12">
        <div class="block-heading">
            ...
            <a href="#widget2container" data-toggle="collapse">NEWS Details</a>
        </div>
        <div id="widget2container" class="block-body collapse in">
            ...
            <thead>
              ...
              <tbody>
              <?php $qury1=mysql_query("SELECT * FROM news WHERE ay_id=$acyear AND Status='1' ORDER BY n_id DESC"); 
						$count =1;
                  ...
                  <tr>
                      ...
                      <td><?php echo $row3['n_title']; ?></td>
                      <td width="70%"><?php echo $row3['n_des'];  ?></td>
                    </tr>
                  <?php $count++; } ?>
              </tbody>
            </table>
