...
<div class="row-fluid">
			  ...
			  while($row1=mysql_fetch_array($qry1))
        		{
					$mno=$row1['m_no'];
					if($mcount==1){?>
                 <a href="pattendance.php?cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&mid=<?php echo $row1['m_id']; ?>&bid=<?php echo $bid;?>" class="btn btn-warning btn-large" style="margin:0px 0 0 10px;"><?php echo $row1['m_name']; ?></a>
                <?php } if($mno==$monthno){
						$mcount=0;
					} }
					 ?> 
    ...
    <div class="block span9">
        <a href="#tablewidget" class="block-heading" data-toggle="collapse"><?php echo $class['c_name']." - ".$section['s_name'];?> Attendance Details<span class="label label-warning"><?php echo $month['m_name'];?> Month</span></a>
