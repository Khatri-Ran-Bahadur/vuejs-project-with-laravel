        ...
        <div id="widget2container" class="block-body collapse in">
            ...
            <thead>
              ...
              <?php $qury1=mysql_query("SELECT * FROM subject WHERE c_id=$cid AND s_id=$sid AND ay_id=$acyear AND b_id=$bid"); 
					...
					$select_record2=mysql_query("SELECT * FROM ssfeedback WHERE c_id=$cid AND s_id=$sid AND ss_id=$ssid AND ay_id=$acyear AND status='1' AND send='staff'");						
								$unread=0;
                  ...
                  <tr>
                      ...
                      <td><a href="feedback_reply1.php?stid=<?php echo $result3['st_id'];?>" class="btn btn-primary">View</a></td>
                  </tr>
                  <?php } $totasl++; }
