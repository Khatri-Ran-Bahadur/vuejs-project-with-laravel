			  ...
			  while($row1=mysql_fetch_array($qry1))
        		{
					...
					if($mcount==1){?>
                 <center>
<li><a href="phomework.php?cid=<?php echo $cid;?>&sid=<?php echo $sid;?>&mid=<?php echo $row1['m_id'];?>&bid=<?php echo $bid;?>" class="btn btn-warning btn-large" style="padding:5px 60px;"><?php echo $row1['m_name'];?> Month</a></li><br>
</center>
                <?php } if($mno==$monthno){
						$mcount=0;
					} } ?> 
