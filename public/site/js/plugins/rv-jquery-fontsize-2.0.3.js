    ...
    Plugin.prototype = {
        ...
        defineElements: function() {
            ...
            if( _self.options.controllers.append !== false ){
                var resetButton = _self.options.controllers.showResetButton ? '<a href="#" class="rvfs-reset" title="Default font size">A</a>' : '';
                ...
                if( $.trim(template).length > 0 ){
                    ...
                    controllersHtml = '' +
                                            '<a href="#" class="rvfs-decrease" title="Decrease font size">A-</a>' +
                                            resetButton +
                                            '<a href="#" class="rvfs-increase" title="Increase font size">A+</a>' +
                                      '';
                }
